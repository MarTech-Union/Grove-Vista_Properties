...
const heroImage = "https://ik.imagekit.io/kc8kqzi2u/Grove%20Vista%20Properties/Properties/marathon.webp";

const keyFacts = [
  { value: "55+", label: "Years of legacy" },
  { value: "100+", label: "Projects delivered" },
  { value: "10,000+", label: "Happy families" },
  { value: "1,500+", label: "Homes in pipeline" },
];

const storyCards = [
  {
    title: "Affordability",
    desc: "Quality homes should be accessible to every family — Marathon delivers value without compromise across every price point, from affordable housing to premium residences.",
    icon: (
  ...
  {
    title: "Scale",
    desc: "From Dombivli to Panvel, Marathon builds large integrated townships that create entire self-sufficient communities — with schools, hospitals, and retail built right in.",
    icon: (
      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: "Trust",
    desc: "Decades of on-time delivery and transparent dealings have made Marathon one of Mumbai's most trusted developers — a reputation earned project by project since 1969.",
    icon: (
      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: "Marathon designs townships with schools, hospitals, and retail built-in — reducing dependence on city infrastructure and creating lasting, self-reliant communities for generations.",
    icon: (
      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const leadershipItems = [
  {
    title: "Our Origin — Since 1922",
    desc: "Our patriarch played a key role in creating the master plan for 550 acres of the suburb of Mulund in 1922 — resulting in one of Mumbai's best-planned suburbs today. The company was formally established in 1969, and we have not looked back since.",
    icon: (
      <svg className="h-6 w-6 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
    ),
    link: "https://marathon.in/about-us/",
  },
  {
    title: "Shaping the Mumbai Metropolitan Region",
    desc: "Today, Marathon has iconic projects spanning the entire MMR — from affordable townships in Dombivli and Panvel to ultra-luxury skyscrapers and Grade A commercial centres in the heart of the city.",
    icon: (
      <svg className="h-6 w-6 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    link: "https://marathon.in/projects/",
  },
];
...
export default function MarathonPage() {
  ...
  useEffect(() => {
    fetch("/api/developer-faqs?developer=marathon")
      .then((r) => r.json())
      .then((d) => setFaqs(d.items || []))
      .catch(() => {});
    fetch("/api/developer-projects?developer=Marathon Group")
      .then((r) => r.json())
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden border-b border-slate-100 bg-gradient-to-br from-slate-900 via-slate-800 to-zinc-900 pb-20 pt-12">
        ...
        <div className="pointer-events-none absolute -bottom-20 right-0 h-96 w-96 rounded-full bg-sky-500/8 blur-[100px]" />
 ...
 <div className="relative mx-auto max-w-7xl px-12 md:px-16 2xl:max-w-screen-2xl">
          ...
          <nav className="mb-10 flex items-center gap-2 text-[12.5px] font-medium text-white/50">
            ...
            <span className="text-white/80">Marathon Group</span>
          </nav>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-5 max-w-lg text-lg leading-relaxed text-slate-400">
                A 55+ year old Mumbai-based real estate developer that has completed over 100 projects across the city — building townships, affordable housing, ultra-luxury skyscrapers, and large business centres across the entire Mumbai Metropolitan Region.
              </p>
            ...
            <div className="relative mt-12 lg:mt-0">
              <div className="relative h-[300px] sm:h-[350px] lg:h-[440px] overflow-hidden rounded-3xl border border-white/10 shadow-2xl">
                <Image
                  src={heroImage}
                  alt="Marathon Group township development"
                  fill
                ...
                <div className="absolute bottom-6 left-6">
                  <p className="font-accent text-[10px] font-bold uppercase tracking-[0.2em] text-amber-400">Since 1969</p>
                  <p className="font-serif text-xl font-semibold text-white">Building Communities, Not Just Homes</p>
                </div>
              </div>
              <div className="absolute -bottom-5 -right-2 sm:-right-5 rounded-2xl border border-white/10 bg-slate-800 px-6 py-4 shadow-2xl">
                ...
                <p className="text-[11px] font-medium text-slate-400">Projects delivered</p>
              </div>
            </div>
          </div>
        </div>
                ...
                <article key={project.id} className="group flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                  ...
                  <div className="flex flex-1 flex-col p-6 2xl:p-9">
                    ...
                    <div className="mt-auto">
                      <button onClick={(e) => { e.preventDefault(); window.location.href='/book?property=Marathon+Group'; }} className="w-full rounded-xl border border-slate-200 py-2.5 text-[13px] font-semibold text-slate-700 transition-all hover:border-amber-300 hover:bg-amber-50 hover:text-amber-800" type="button">Enquire Now</button>
                    </div>
                  </div>
                </article>
              );
 ...
 <div className="mx-auto max-w-7xl px-12 md:px-16 2xl:max-w-screen-2xl">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto mt-4 max-w-xl text-[14.5px] leading-relaxed text-slate-500">
              55 years of building not just homes, but thriving communities — grounded in affordability, scale, trust, and sustainability.
            </p>
          </div>
      ...
      <section className="relative overflow-hidden bg-slate-900 py-20">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_70%_60%_at_top_right,rgba(251,191,36,0.08),transparent),radial-gradient(ellipse_50%_40%_at_bottom_left,rgba(14,165,233,0.07),transparent)]" />
 <div className="relative mx-auto max-w-4xl px-12 md:px-16 text-center 2xl:max-w-5xl">
          ...
          <h2 className="font-serif mb-5 text-[clamp(1.7rem,3.5vw,2.6rem)] font-semibold text-white">
            Interested in a Marathon Project?
          </h2>
          <p className="mx-auto mb-10 max-w-xl text-[15px] leading-relaxed text-slate-400">
            Our advisors have direct relationships with Marathon Group&apos;s sales team and can secure priority access, pre-launch pricing, and exclusive floor plans for you.
          </p>
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <button
              onClick={(e) => { e.preventDefault(); window.location.href='/book?property=Marathon+Group'; }}

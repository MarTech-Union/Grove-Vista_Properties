      ...
      <section className="relative overflow-hidden border-b border-slate-800 bg-gradient-to-br from-slate-900 via-slate-800 to-zinc-900 pb-20 pt-12 px-6 sm:px-10 lg:px-8 2xl:px-10">
        ...
        <div className="relative mx-auto max-w-screen-2xl">
          ...
          <nav className="mb-10 flex items-center gap-2 text-[12.5px] font-medium text-white/50">
            ...
            <span className="text-white/80">Properties for Sale in Mumbai</span>
          </nav>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-5 max-w-lg text-lg leading-relaxed text-slate-400">
                Discover curated residential and commercial properties across Mumbai&apos;s most sought-after cities — verified listings, transparent pricing, expert guidance.
              </p>
            ...
            <div className="relative mt-12 lg:mt-0">
              <div className="relative h-[300px] sm:h-[350px] lg:h-[440px] overflow-hidden rounded-3xl border border-white/10 shadow-2xl">
                <Image
                  src={heroImage}
                  alt="Luxury property for sale in Mumbai"
                  fill
                ...
                <div className="absolute bottom-6 left-6">
                  ...
                  <p className="font-serif text-xl font-semibold text-white">Premium Properties Across Mumbai</p>
                </div>
              </div>
        ...
        <div className="mb-8 flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <h2 className="font-serif text-3xl font-bold text-slate-900">
              {propertyFor === "commercial" ? "Commercial" : "Residential"} Properties for Sale in Mumbai
            </h2>

...
const heroImage = "https://ik.imagekit.io/kc8kqzi2u/Grove%20Vista%20Properties/Properties/Oberoi.webp";

const keyFacts = [
  { value: "40+", label: "Years of excellence" },
  { value: "45M+", label: "Sq. ft. delivered" },
  { value: "11", label: "Ongoing projects" },
...
const storyCards = [
  {
    title: "People First",
    desc: "Oberoi Realty prioritises people in everything — employees, customers, and all stakeholders — making human-centred design the foundation of every project.",
    icon: (
  ...
  },
  {
    ...
    desc: "Every Oberoi development achieves desired results through continual improvement — benchmarked against the best global trends and built to exceed expectations.",
    icon: (
      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: "Consistency in honesty, transparency, and accountability has built Oberoi Realty into Mumbai&apos;s most trusted real estate brand over four decades.",
    icon: (
      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    desc: "By transforming imagination into reality, Oberoi Realty continuously pushes the boundaries of design, technology, and lifestyle across every new development.",
    icon: (
      <svg className="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const leadershipItems = [
  {
    ...
    desc: "Experienced industry leaders guiding Oberoi Realty's strategy, governance, and long-term value creation — ensuring sustained excellence as the company grows.",
    icon: (
      <svg className="h-6 w-6 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.75} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" />
      </svg>
    ),
    link: "https://www.oberoirealty.com/about-us/leadership",
  },
  {
    title: "Our Vision",
    desc: "To create spaces that enhance the quality of life — revolutionary, ahead of the times, and built around the discerning needs of every customer who experiences an Oberoi development.",
    icon: (
      <svg className="h-6 w-6 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    link: "https://www.oberoirealty.com/about-us",
  },
];

export default function OberoiGroupPage() {
  ...
  useEffect(() => {
    fetch("/api/developer-faqs?developer=oberoi")
      .then((r) => r.json())
      .then((d) => setFaqs(d.items || []))
      .catch(() => {});
    fetch("/api/developer-projects?developer=Oberoi Realty")
      .then((r) => r.json())
 ...
 <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 2xl:max-w-screen-2xl">
          ...
          <nav className="mb-10 flex items-center gap-2 text-[12.5px] font-medium text-white/50">
            ...
            <span className="text-white/80">Oberoi Realty</span>
          </nav>
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-5 max-w-lg text-lg leading-relaxed text-slate-400">
                For over four decades, Oberoi Realty has been an insignia of trust, transparency, and cutting-edge design in Mumbai — rooted in values and committed to enhancing the quality of life through every development.
              </p>
            ...
            <div className="relative mt-12 lg:mt-0">
              <div className="relative h-[300px] sm:h-[350px] lg:h-[440px] overflow-hidden rounded-3xl border border-white/10 shadow-2xl">
                <Image
                  src={heroImage}
                  alt="Oberoi Realty landmark development"
                  fill
                ...
                <div className="absolute bottom-6 left-6">
                  ...
                  <p className="font-serif text-xl font-semibold text-white">Shaping Mumbai&apos;s Skyline</p>
                </div>
              </div>
              <div className="absolute -bottom-5 -right-2 sm:-right-5 rounded-2xl border border-white/10 bg-slate-800 px-6 py-4 shadow-2xl">
                <p className="font-serif text-3xl font-bold text-white">45M+</p>
                ...
                <article key={project.id} className="group flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
                  ...
                  <div className="flex flex-1 flex-col p-6 2xl:p-9">
                    ...
                    <div className="mt-auto">
                      <button onClick={(e) => { e.preventDefault(); window.location.href='/book?property=Oberoi+Group'; }} className="w-full rounded-xl border border-slate-200 py-2.5 text-[13px] font-semibold text-slate-700 transition-all hover:border-amber-300 hover:bg-amber-50 hover:text-amber-800" type="button">Enquire Now</button>
                    </div>
                  </div>
                </article>
              );
 ...
 <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 2xl:max-w-screen-2xl">
          <div className="mb-12 text-center">
            ...
            <h2 className="font-serif text-[clamp(1.8rem,3.5vw,2.6rem)] font-semibold leading-tight text-slate-900">
              The Six Pillars We Stand On
            </h2>
            <p className="mx-auto mt-4 max-w-xl text-[14.5px] leading-relaxed text-slate-500">
              Four decades of trust built on an unwavering commitment to people, quality, and integrity in everything we deliver.
            </p>
          </div>
 ...
 <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 text-center 2xl:max-w-5xl">
          ...
          <h2 className="font-serif mb-5 text-[clamp(1.7rem,3.5vw,2.6rem)] font-semibold text-white">
            Interested in an Oberoi Project?
          </h2>
          <p className="mx-auto mb-10 max-w-xl text-[15px] leading-relaxed text-slate-400">
            Our advisors have direct relationships with Oberoi Realty&apos;s sales team and can secure priority access, pre-launch pricing, and exclusive floor plans for you.
          </p>
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <button
              onClick={(e) => { e.preventDefault(); window.location.href='/book?property=Oberoi+Group'; }}
